package bj.armyworm.mobile.view;
...
import bj.armyworm.mobile.webservicesproxy.*;
import bj.armyworm.mobile.webservicesproxy.data.FawData;
...
public class ClientViews {
    ...
    public void start() {
        ...
        /** A partir d'ici on peut inserer la photo dan la base apres
           pris la photo **/
        String[] newpest = new String[4];
        newpest[0]= ""; //ID un integer 
        newpest[1]= ""; //la couleur peut etre null 
        newpest[2]= ""; //le lien vers la photo 
        Date date = new Date();
        newpest[3]= date.toString(); //la date 
        try {
        	
			FawData.createPestRecord(newpest);
